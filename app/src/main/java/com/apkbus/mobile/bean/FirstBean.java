...
public class FirstBean {
    ...
    public Object getTodayposts() {
        return todayposts;
    }

    public void setTodayposts(Object todayposts) {
    ...
    public void setHourviews(String hourviews) {
        this.hourviews = hourviews;
    }
    ...
    public void setTodayviews(String todayviews) {
